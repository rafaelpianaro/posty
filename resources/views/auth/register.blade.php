        ...
        <div class="w-4/12 bg-white p-6 rounded-lg">
            <form action="{{ route('register') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    @error('nome') border-red-500 @enderror" value="{{ old('nome') }}">
                    @error('nome')
                ...
                <div class="mb-4">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation" placeholder="Repeat yout password"
